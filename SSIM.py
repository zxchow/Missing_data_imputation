...
class SSIM(tf.keras.Model):
    def __init__(self, encoder_units, channel_size=5, feature_size=3):
        ...
        self.data_dimension = channel_size * feature_size
    ...
    def call(self, x):
        ...
        encoder_output = self.encoder(x, mask=masking)
        ...
        seq_res = tf.reshape(seq_res, [batch_size, sequence_length - 1, channel_size, feature_size])[:, :, :, 0]
